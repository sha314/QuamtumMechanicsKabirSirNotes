...
\begin{enumerate}
	...
	\begin{align}
		...
		-\iu \hbar \frac{\partial}{\partial q} \braket{q}{p} &= p \braket{q}{p}
	\end{align}
	...
	\begin{align*}
		\braket{p}{p^\prime} 
		&= \int dq \braket{p}{q}\braket{q}{p^\prime} \\
		&= \int dq C^* e^{-ipq/\hbar} C^{\iu p^\prime q /\hbar} \\
		&= \left|C\right|^2 \int_{-\infty}^{\infty} dq e^{-\iu(p-p^\prime)q/\hbar} \\
